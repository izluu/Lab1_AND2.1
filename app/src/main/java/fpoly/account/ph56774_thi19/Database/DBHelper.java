...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public static final int DB_VERSION = 5; // Tăng phiên bản cơ sở dữ liệu
    public static final String COLUMN_ID = "ID";
    public static final String COLUMN_TITLE = "TITLE";
    public static final String COLUMN_CONTENT = "CONTENT";
    public static final String COLUMN_DATE = "DATE";
    public static final String COLUMN_STYLE = "STYLE";
    public static final String COLUMN_SRC = "SRC"; // Thêm cột SRC
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        String createTable = "CREATE TABLE " + TABLE_SANPHAM_NAME + " (" +
                ...
                COLUMN_SRC + " TEXT)"; // Thêm cột SRC vào câu lệnh tạo bảng
